    ...
    ?>
        <div style="width: 100%; display: flex; justify-content: center; height: 20vh;">
            <a href="primer1.php?id_tov=<?php echo $ss['id'] ?>" class="kek">
                ...
                <div style="width: 50vh; height: 20vh; margin-left: 6vh; margin-top: 15vh; font-size: 3.5vh"><?php echo $ss['name'] ?></div>
                <div style="width: 20vh; height: 20vh; margin-top: 17vh; font-size: 2.5vh"><a href="../utilites/korz.php?id_ukr=<?php echo $_GET['id_tov'] ?>">Добавить в корзину</a></div>
