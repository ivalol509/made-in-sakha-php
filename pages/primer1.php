    ...
    <div style="margin-left:80px">
        ...
        <div class="container">
            <div class="row">
                ...
                <br>
                <div class="col-sm block" style="width: 525px; margin-left: 100px;padding-right: 0; line-height: 45px">
                    <span  class="e68_3">Каждое звено, является отдельным и при движении головы серьги начинают “танцевать”</span>
                </div>
                <div class="col-sm block" style="width: 525px; margin-left: 20px; padding-right: 0; line-height: 45px; margin-top: 20px">
                    <span style="" class="e68_2">Застежка: Английская Металл: Серебро 925 пробы Размер: 5,5 см</span>
                </div>
                    <div class="col-sm block">
                        <h1 style="font-weight: bold; font-family: Bitter; font-size: 48px; margin-top: -10px;margin-left: 70px">
                            3000
                        </h1>
                        <a href="../utilites/ponr.php?id_ukr=<?php echo $_GET['id_tov'] ?>"><img src="../img/bbb.png" style="width: 30px; height: 35px; margin-top: -2px; margin-left: 4px"></a>
                        <a type="button" class="btn-black" href="../utilites/korz.php?id_ukr=<?php echo $_GET['id_tov'] ?>">
                            Добавить в карзину
                        </a>
                </div>
...
<p>
    <img src="../image/primer/1.jfif" alt="Фотография 1" width="155" height="145" style="border-radius: 15px; margin-left: 230px; margin-top: 40px">
    <img src="../image/primer/1.jfif" alt="Фотография 2" width="155" height="145" style="border-radius: 15px; margin-left: 5px;margin-top: 40px">
    <img src="../image/primer/1.jfif" alt="Фотография 3" width="155" height="145" style="border-radius: 15px; margin-left: 5px;margin-top: 40px">
...
<div class="container" style="margin-top: 48px">
    <a style="margin-left: 250px;margin-top: 48px; font-color: #6c6c6c">Посмотреть в Instagram</a>
</div>
...
<div>
    <div class="col-sm block" style="margin-top: 30px">
        <p class="text3">Серьги “Танцующий чороон”</p>
    </div>
    <div class="col-sm-block">
